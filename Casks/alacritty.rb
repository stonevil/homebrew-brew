cask "alacritty" do
  ...
  postflight do
    system_command '/usr/bin/curl',
      args: ['-L', '-o', "#{appdir}/Alacritty.app/Contents/Resources/alacritty.icns", "https://github.com/stonevil/homebrew-brew/raw/refs/heads/main/Resources/alacritty.icns"]
    system_command '/usr/bin/xattr',
      args: ['-r', '-d', 'com.apple.quarantine', "#{appdir}/Alacritty.app"]
  end
